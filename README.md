...
We extend the modeling elements and attributes based on BPMN2.0. For typical Industrial Internet business requirements, we extend ten elements and three attributes. As shown in below figure, the red box represents element extensions and the purple box represents attribute extensions.
