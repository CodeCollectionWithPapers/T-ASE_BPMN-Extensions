...
var entryFactory = __webpack_require__(/*! clipboard-copy */ "./node_modules/bpmn-js-properties-panel/lib/factory/EntryFactory.js");
var extensionHelper = __webpack_require__(/*! bpmn-js-properties-panel/lib/helper/FormHelper */ "./node_modules/bpmn-js-properties-panel/lib/helper/ExtensionElementsHelper.js");
var tabEntryFac = __webpack_require__("./node_modules/bpmn-js-properties-panel/lib/factory/TableEntryFactory.js");
...
function GeneratedFormPreviewPluginProvider(injector) {
  ...
  this.getTabs = function(element) {
	...
	var extensionTab = array.filter(function(item, index) {
//		console.log('!!!!!!!!!!!!!!'+item.id);
	      if (item.id == 'extensionElements') {
	        extensionIndex = index;
//	        console.log('yes!'+extensionIndex+'  '+' '+formIndex);
			return true;
			
	      }
	    });

	var extensionElement = element.businessObject.get("extensionElements")
	
	if (is(element, 'bpmn:SendTask') || is(element, 'bpmn:ReceiveTask')|| is(element, 'bpmn:UserTask')){
		
		
		//add new button
		var  mydom=document.getElementsByClassName("action-button add")
		var self = this;
//		var addElements = new tabEntryFac(element);
//		console.log('newTest!!!!!!!!!!'+addElements.factory.id)
		console.log('newTest!!!!!!!!!!'+mydom[0])
		console.log('newTest!!!!!!!!!!'+Object.values(mydom))
		console.log('123newTest!!!!!!!!!!'+mydom[5])
//		button class: action-button addpreview-button      data-action:openPreview
		
//		var addButton = document.createElement("button")
//		addButton.innerHTML = "+";
//		addButton.setAttribute('index',1)
//		addButton.setAttribute('id','addbnt')
//		extensionTab[0].groups[0].entries.push(addButton);
	//!!!!!!!!!!!!!!!!!!!!!!!!!!!!! this is the real button!!	
//	    extensionTab[0].groups[0].entries.splice(1, 0, {
//	      html: "<br /> <button class='preview-button' id='1111111' data-action='Mymethod'>Add Message Field  +</button> <br /> <br />",
//	      id: "my-button",
//			 
...
//			//	emptyParameter: true,
//			};
//			extensionTab[0].groups[0].entries.push(entryFactory.textBox(trans,trans));
////			extensionTab[0].groups[0].entries.splice(1,0,trans)
////			cnt++;
//	      },
//		
//	    });
...
////			};
////			
////			extensionTab[0].groups[0].entries.push(entryFactory.textField(trans,trans));
//		var cnt = 0   //计数索引
//		var flag = false;
//		extensionTab[0].groups[0].entries.push({
//		
//		html: "<div class='block' id='9527' > <br /> <button class='preview-button' id='111' data-action='Mymethod'>Add Message Field  +</button> <br /> <br /> </div>",
//	    id: "my-button",
//		Mymethod: function() {
//// Method1	
////				alert("你好，我是一个警告框！");
//				var element1 = document.getElementById("9527")
////				document.getElementById('111').style.color='red'
//				//创建html元素，加在已有元素后面
//				var myinput1=document.createElement("input")
//				myinput1.setAttribute('id',cnt)
//				element1.appendChild(myinput1)
//				cnt++ 
//				var myinput2=document.createElement("input")
//				myinput2.setAttribute('id',cnt)
//				element1.appendChild(myinput2)
//				
//				var delButton = document.createElement("button")
//				delButton.innerHTML = "×";
//				delButton.setAttribute('index',cnt)
//				delButton.setAttribute('id','delbnt'+cnt)
////				delButton.setAttribute('style','padding-right:10px')
////				delButton.setAttribute('position','absoulte')
////				delButton.setAttribute('right','30px')
//				delButton.onclick = function(){
////    				alert('Sure to delete?');
//					var index = delButton.getAttribute('index')
//					console.log(typeof index)
//					var input1obj = document.getElementById(index);//获取删除该列的第二个文本框索引
//    				var btnParent = input1obj.parentNode;//获取input的父对象
//					var input2index = Number(index)-1  //获取第一个文本框的索引
//					var input2obj = document.getElementById(input2index);
//					
//					btnParent.removeChild(input1obj);//通过input2的父对象div,删除input1
//					btnParent.removeChild(input2obj);
//					btnParent.removeChild(delButton);
//				};
//				
//				element1.appendChild(delButton)
//				
//				cnt++ 
//				
//// Method2
...
////
////				Divflag.setAttribute('Divindex',111111111111111111)	 
//	
//		
//	      },
//
...
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
//	    extensionTab[0].groups[0].entries.splice(1, 0, addElement);
...
//		};
//
//		extensionTab[0].groups[0].entries.push(entryFactory.button(translate_btn,translate_btn));
	    ...
	    modelProperty: 'SelectFlag',    //下拉框的字段名
		defaultText:"race"
	//	emptyParameter: true,
	    };

		console.log('这是在测试属性的长度'+extensionTab[0].groups[0].entries.length);
		extensionTab[0].groups[0].entries.push(entryFactory.selectBox(translate_x,translate_x));	//扩展下拉框
		console.log('这是在测试属性的长度!!!!!'+extensionTab[0].groups[0].entries.length);
	//	console.log('EXIT!!!!!     '+extensionTab[0].groups[0].entries[0].id+'  '+Object.keys(extensionTab[0].groups[0].entries[1]));
	//	console.log(extensionTab[0].groups[0].entries[1].setControlValue);
		
		var  myselect=document.getElementById("camunda-Condition-select");
		if(myselect!=null){
		    ...
		    modelProperty: 'NumVal',    //在BPMN中是下拉框中值的字段名
		//	emptyParameter: true,
		    };
		    ...
		    modelProperty: 'NumVal1',    //在BPMN中是下拉框中值的字段名
		//	emptyParameter: true,
		    };
			...
			modelProperty: 'TimeVal1',
			//	emptyParameter: true,
			};
			
			if(myselect.value == 1){
				extensionTab[0].groups[0].entries.push(entryFactory.textField(translate3,translate3));
	//			document.getElementById("camunda-Condition-select").value = 1;	
				console.log('当前选中'+myselect.value+'    '+document.getElementById("camunda-Condition-select").value);
				
			}
			else if(myselect.value == 2){
				extensionTab[0].groups[0].entries.push(entryFactory.textField(translate4,translate4));
	//			document.getElementById("camunda-Condition-select").value = 2;	
				console.log('当前选中'+myselect.value+'    '+document.getElementById("camunda-Condition-select").value);
				
			}
			else if(myselect.value == 3){
				extensionTab[0].groups[0].entries.push(entryFactory.textField(translate5,translate5));
				extensionTab[0].groups[0].entries.push(entryFactory.textField(translate6,translate6));
	//			document.getElementById("camunda-Condition-select").value = 3;	
				console.log('当前选中'+myselect.value+'    '+document.getElementById("camunda-Condition-select").value);
...
//	    });
//
//	if (is(element, 'bpmn:SendTask') || is(element, 'bpmn:ReceiveTask')){
////!!!!!!!!!!!!!!!!!!!!!!!!done code
//		var cnt = 0   //计数索引
//		extensionTab[0].groups[0].entries.push({
//			
...
//				
////			extensionTab[0].groups[0].entries.push({
////			html: "<br /> <button class='preview-buttons' id='123' data-action='Mymethods'>sub btn  +</button> <br /> <br />",
////	   		id: "my-buttons",	
////			});
//
//	      },
...
//add new button
			//var  mydom=document.getElementByClassName("bpp-table-add-row");
//		var self = this;
//		var addElements = tabEntryFac.addElement;
//		console.log('newTest!!!!!!!!!!'+addElements)
		
		//button class: action-button add        preview-button      data-action:openPreview
		
//	    extensionTab[0].groups[0].entries.splice(1, 0, {
//	      html: "<br /> <button class='preview-button' data-action='openPreview'>Add Message Field  +</button> <br /> <br />",
//	      id: "form-fields-generate-button",
//			
//		  
//	      openPreview: function(element, node) {
